...
then
 ...
 salloc --nodes=1 --ntasks-per-node=24 --exclude=taurusi[6001-6612]  --time=00:05:00 --mem-per-cpu=1900 --partition=haswell bash -c "ulimit -s unlimited && mpirun -np 24 src/vcluster --report_level=no"
 if [ $? -ne 0 ]; then exit 1 ; fi
 sleep 5
 salloc --nodes=2 --ntasks-per-node=24 --exclude=taurusi[6001-6612] --time=00:05:00 --mem-per-cpu=1900 --partition=haswell bash -c "ulimit -s unlimited && mpirun -np 48 src/vcluster --report_level=no"
 if [ $? -ne 0 ]; then exit 1 ; fi
 sleep 5
 salloc --nodes=4 --ntasks-per-node=24 --exclude=taurusi[6001-6612] --time=00:05:00 --mem-per-cpu=1900 --partition=haswell bash -c "ulimit -s unlimited && mpirun -np 96 src/vcluster --report_level=no"
 if [ $? -ne 0 ]; then exit 1 ; fi
 sleep 5
 salloc --nodes=8 --ntasks-per-node=24 --exclude=taurusi[6001-6612] --time=00:05:00 --mem-per-cpu=1900 --partition=haswell bash -c "ulimit -s unlimited && mpirun -np 192 src/vcluster --report_level=no"
 if [ $? -ne 0 ]; then exit 1 ; fi
 sleep 5
 salloc --nodes=10 --ntasks-per-node=24 --exclude=taurusi[6001-6612] --time=00:5:00 --mem-per-cpu=1900 --partition=haswell bash -c "ulimit -s unlimited && mpirun -np 240 src/vcluster --report_level=no"
 if [ $? -ne 0 ]; then exit 1 ; fi
